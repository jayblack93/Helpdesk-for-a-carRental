...
public class JAXB_XMLParser {
	...
	private CarRental ourrental = null;            // the main object containing all data
	...
	public CarRental loadXML(InputStream fileinputstream) {
